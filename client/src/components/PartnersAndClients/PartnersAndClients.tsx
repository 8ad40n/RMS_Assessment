...
export default function PartnersAndClients() {
  return (
    <div className="container max-w-7xl mx-auto text-auto mb-8 md:mb-12 px-4">
        <div className="flex items-center justify-center">
            <div className="w-full">
                <div className=" md:mb-2">
                    <h4 className="text-sm md:text-base text-[#A52A2A] text-center font-bold mb-1 md:mb-2">Partners & Clients</h4>
                    <h1 className="text-3xl md:text-4xl font-bold text-center text-black">We work with the best pepole</h1>
                </div>
